...
$var = querycoba("SELECT * FROM transaksi_pendapatan");
...
<body class="bg-gradient-to-l from-[#845EC2] via-[#FF6F91] to-[#FFC75F]">
    <div class="w-full h-full">
        <div class="flex object-scale-down">
            <label for="pengeluaran" class="my-3 mx-auto bg-[#845EC2] rounded-lg p-4 text-white font-bold">
                Pendapatan
            </label>
        </div>
        <div class="flex object-scale-down">
