...
<body class="bg-gradient-to-tr from-[#845EC2] via-[#FF6F91] to-[#FFC75F]">
    ...
    <div class="flex">
        ...
        <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" class="text-white bg-transparent mr-0 mx-auto hover:font-bold focus:outline-none font-medium rounded-lg text-lg px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:hidden" type="button">
    ...
    <div id="dropdownDivider" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDividerButton">
            <li>
                <a href="landing.php" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Home</a>
            </li>
            <li>
                <a href="about.php" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">About</a>
            </li>
            <li>
                <a href="register.php" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Daftar</a>
            </li>
        </ul>
        <div class="py-1">
            <a href="login.php" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Login</a>
        </div>
    </div>
                            ...
                            <div>
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" required class="my-1 px-3 py-0.5 shadow-xl block rounded-full bg-white w-full border-[1px] md:w-full"><br>
                                        <div>
                                            <label for="username" class="text-sm p-3">Username</label>
                                        </div>
                                        <input type="text" id="username" required class="my-1 px-3 py-0.5 shadow-xl block rounded-full  bg-white w-full border-[1px] md:w-full"><br>
                                        <div>
                                            <label for="telp" class="text-sm p-3">No. Telp</label>
                                        </div>
                                        <input type="tel" id="telp" required class="my-1 px-3 py-0.5 shadow-xl block rounded-full  bg-white w-full border-[1px] md:w-full"><br>
                                        <div>
                                            <label for="pass" class="text-sm p-3">Password</label>
                                        </div>
                                        <input type="password" id="pass" required class="my-1 px-3 py-0.5 shadow-xl block rounded-full  bg-white w-full border-[1px] md:w-full"><br>
                                        <div>
                                            <label for="konfirmpass" class="text-sm p-3">Konfirmasi Password</label>
                                        </div>
                                        <input type="password" id="konfirmpass" required class="my-1 px-3 py-0.5 shadow-xl block rounded-full  bg-white w-full border-[1px] md:w-full"><br>
                                    </div>
                                    </p>
                                    <a href="#" class="flex p-1 bg-[#845EC2] hover:bg-[#643EA3] text-white w-full my-7 font-bold justify-center rounded-full md:w-full">Register
                                    </a>
