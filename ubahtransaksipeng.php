                ...
                <div class="px-5">
                    <div
                        ...
                        <div class=" sm:mb-0 py-0.5  sm:w-64 md:w-[400px] w-3/4 rounded-full mx-auto bg-white mb-2">
                            <input value="<?= $transaksi['bukti_Transaksi'] ?>" name="buktit" type="text" id="nama"
                                placeholder="Bukti Transaksi" required
                        ...
                        <div class=" sm:mb-0 py-0.5  sm:w-64 md:w-[400px] w-3/4 rounded-full mx-auto bg-white mb-2">
                            <input name="jenist" type="text" id="nama" placeholder="Jenis Transaksi" required
                                class="focus:ring-black shadow-lg bg-transparent border-[1.7px] border-black focus:border-black font-bold placeholder:text-slate-500 focus:text-black px-5 rounded-full w-full h-full">
                        </div>
                        <div class=" sm:mb-0 py-0.5  sm:w-64 md:w-[400px] w-3/4 rounded-full mx-auto bg-white mb-2">
                            <input name="tglt" type="date" id="nama" placeholder="Tanggal Transaksi" required
                                class="focus:ring-black shadow-lg bg-transparent border-[1.7px] border-black focus:border-black font-bold placeholder:text-slate-500 focus:text-black px-5 rounded-full w-full h-full">
                        </div>
                        <div class=" sm:mb-0 py-0.5  sm:w-64 md:w-[400px] w-3/4 rounded-full mx-auto bg-white mb-2">
                            <input name="not" type="text" id="nama" placeholder="Nomor Transaksi" required
                                class="focus:ring-black shadow-lg bg-transparent border-[1.7px] border-black focus:border-black font-bold placeholder:text-slate-500 focus:text-black px-5 rounded-full w-full h-full">
                        </div>
                        <div class=" sm:mb-0 py-0.5  sm:w-64 md:w-[400px] w-3/4 rounded-full mx-auto bg-white mb-2">
                            <input name="statust" type="text" id="nama" placeholder="Status" required
                                class="focus:ring-black shadow-lg bg-transparent border-[1.7px] border-black focus:border-black font-bold placeholder:text-slate-500 focus:text-black px-5 rounded-full w-full h-full">
                        </div>
                        <div
                    ...
                    <table
                        ...
                        <tbody class="text-purple-900 text-center justify-center font-semibold">
                            ...
                            <tr class="bg-purple-200 mx-auto">
                                ...
                                <td class="py-3 px-1 md:px-[5px] lg:px-[20px]"><a
                                        href="hapus.php?id=<?= $baris['Id_Barang']; ?>"
                                        onclick="return confirm('yakin?')" class="hover:text-red-700">Hapus</a></td>
                                <td class="py-3 px-1 md:px-[5px] lg:px-[20px]"><a
                                        href="ubah.php?id=<?= $baris['Id_Barang']; ?>"
                                        class="hover:text-green-700">Ubah</a></td>
                            </tr>
                            <?php $j++ ?>
                            <?php endwhile ?>
                            <?php endif ?>
