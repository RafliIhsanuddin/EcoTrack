        ...
        <main>
            ...
            <div class="m-6">
                ...
                <ul class="hidden text-sm font-medium text-center rounded-lg divide-x divide-gray-500 border border-gray-300 shadow-sm max-w-[1300px] sm:flex">
                    <li class="w-full">
                        <a href="transpend.php" class="inline-block p-4 w-full text-gray-900 bg-gray-100 rounded-l-lg">Pendapatan</a>
                    </li>
                    <li class="w-full">
                        <a href="transpeng.php" class="inline-block p-4 w-full text-gray-900 bg-white rounded-r-lg">Pengeluaran</a>
                    </li>
                </ul>
