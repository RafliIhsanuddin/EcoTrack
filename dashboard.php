                    ...
                    <div class="flex w-full justify-center">
                        <div class="p-5">
                            <form action="" method="POST" id="search">
                                <input type="text" id="searchinput" name="keyword" class="rounded-full h-7 w-48 mb-3" placeholder="masukkan keyword..." autocomplete="off">
                                ...
                                <button type="reset" name="reset" class="text-white bg-red-500 hover:bg-red-700 rounded-full h-[29px] w-14 shadow-xl active:shadow-none active:bg-red-700">RESET</button>
                            </form>
                            <table class="w-full">
                                <thead class="bg-gray-300 border-b-2 border-gray-500">
                                    <tr>
